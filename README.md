...
| -- | :--------: | :----: | :--------: | ----------- |
| [eth-geth-internal-value-transfer](go/eth-geth-internal-value-transfer.yaml) | [🛝🔗](https://semgrep.dev/playground/r/trailofbits.go.eth-geth-internal-value-transfer.eth-geth-internal-value-transfer) | 🟧 | 🌕 | Detects when a direct call is made to the Geth's EVM's Transfer function. Callers to this function must be authorized to make the transfer, have the required balance, and the amount must not be negative. |
| [eth-geth-snap-protocol-name-unmodified](go/eth-geth-snap-protocol-name-unmodified.yaml) | [🛝🔗](https://semgrep.dev/playground/r/trailofbits.go.eth-geth-snap-protocol-name-unmodified.eth-geth-snap-protocol-name-unmodified) | 🟩 | 🌘 | Detects when a geth fork doesn't change the snap sync protocol id/version, causing the forked network to peer with Ethereum mainnet. This can lead to unintended consequences, such as wasting resources syncing the wrong chain. |
| [eth-rpc-get-block-by-number-non-final](go/eth-rpc-get-block-by-number-non-final.yaml) | [🛝🔗](https://semgrep.dev/playground/r/trailofbits.go.eth-rpc-get-block-by-number-non-final.eth-rpc-get-block-by-number-non-final) | 🟧 | 🌗 | Flags uses of the BlockByNumber API that do not check for finality. |
| [eth-rpc-subject-to-finality](go/eth-rpc-subject-to-finality.yaml) | [🛝🔗](https://semgrep.dev/playground/r/trailofbits.go.eth-rpc-subject-to-finality.eth-rpc-subject-to-finality) | 🟧 | 🌕 | Flags potentially dangerous uses of the Ethereum API; the functions flagged may return results that are subject to re-orgs, leading to double-spend attacks in exchange and bridge applications. |
